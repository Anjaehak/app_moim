...
public class UserService {
	...
	public UserDetail findSpecificSavedDetail(String accountUserId) {
		
		return userRepository.findById(accountUserId).get().getUserDetail();
		/*
		UserDetail userDetail = userRepository.findById(account.getUsername()).get().getUserDetail();
		if(userDetail == null) {
			return null;
		}
